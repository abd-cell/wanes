...
export const DEFAULT_CONFIG: AppConfiguration = {
  ...
  confirmCutoffMinutes: 60,
  confirmDecisionLeadMinutes: 15,
  minimumPassengersDefault: 3,
  driverSelectionWindowMinutes: 0,
  averageSpeedKmh: 35,
  fareBaseAmount: 0.5,
  farePerKm: 0.1,
  scheduledSelectionWindowMinutes: 20,
  riderOfferChoice: true,
  requireSharedTermsAcceptance: true,
  ...
  suspensionDays: 7,
  boardingCodeRequired: true,
  emergencyNumber: '911',
  shareBaseUrl: '',
  seriesCommitmentsEnabled: true,
