...
public static class BookingStatusRules
{
    ...
    {
        BookingStatus.Arrived => from is BookingStatus.Pending or BookingStatus.Confirmed,
        BookingStatus.InProgress => from is BookingStatus.Pending
            or BookingStatus.Confirmed
            or BookingStatus.Arrived,
        BookingStatus.Completed => from is BookingStatus.InProgress,
        BookingStatus.NoShow => from is BookingStatus.Pending
            or BookingStatus.Confirmed
            or BookingStatus.Arrived,
        _ => false,
    };
