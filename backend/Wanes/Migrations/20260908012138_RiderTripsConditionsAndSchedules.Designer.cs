...
namespace Wanes.Migrations
{
    ...
    [Migration("20260908012138_RiderTripsConditionsAndSchedules")]
    partial class RiderTripsConditionsAndSchedules
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wanes.Areas.Domain.Configuration.AppConfiguration", b =>
                {
                    ...
                    b.Property<int>("PriceAcceptMinutes")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Wanes.Areas.Domain.RiderTrips.RiderTrip", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Wanes.Areas.Domain.RiderTrips.RiderTripHold", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RiderTripId", "RiderId")
                        .IsUnique()
                        .HasFilter("[IsReleased] = 0 AND [IsDeleted] = 0");

                    b.ToTable("RiderTripHolds");
                });
            ...
            modelBuilder.Entity("Wanes.Areas.Domain.Users.User", b =>
                {
                    ...
                    b.Property<int>("PreferredCoRiderGenderPolicy")
                        .HasColumnType("int");

                    b.Property<int>("PreferredDriverGenderPolicy")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Wanes.Areas.Domain.Bookings.Booking", b =>
                {
                    ...
                    b.HasOne("Wanes.Areas.Domain.RiderTrips.RiderTrip", "RiderTrip")
                        .WithMany()
                        .HasForeignKey("RiderTripId")
                        .OnDelete(DeleteBehavior.Restrict);
